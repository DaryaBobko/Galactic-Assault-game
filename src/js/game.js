...
function create() {
    ...
    gameStatus = gameStatuses.startMenu;
...
function startGame(event) {
    playLabel.destroy();
    gameStatus = gameStatuses.gameProcess;
...
function forPause() {
    gameStatus = gameStatuses.gamePause;
...
function update() {
    switch (gameStatus) {
        case gameStatuses.startMenu:
            {
                break;
            }
        case gameStatuses.gameProcess:
            {
                renderGameProcess();
                break;
            }
        case gameStatuses.gamePause:
            {
                break;
            }
    }
